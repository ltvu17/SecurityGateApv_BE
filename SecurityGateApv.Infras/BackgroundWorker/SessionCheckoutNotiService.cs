...
{
    public class SessionCheckoutNotiService : BackgroundService
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<SessionCheckoutNotiService> _logger;
        private Timer _timer;
        public SessionCheckoutNotiService(IServiceProvider serviceProvider, ILogger<SessionCheckoutNotiService> logger)
        {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            var scheduledTime = new DateTime(now.Year, now.Month, now.Day, 19, 00, 0);
            ...
            _timer = new Timer(async _ => await NotiCheckOut(), null, initialDelay, TimeSpan.FromDays(1));
            return Task.CompletedTask;

        }
        private async Task NotiCheckOut()
        {
